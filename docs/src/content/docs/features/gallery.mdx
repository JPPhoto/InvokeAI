...
Videos generated by InvokeAI (currently from the Wan 2.2 model family) appear alongside images in the same gallery view. Each video item displays a representative still as its thumbnail (a frame chosen to skip black lead-ins, fades and title cards) with a play badge in the corner; selecting it opens the video in the viewer where you can play it back inline.
