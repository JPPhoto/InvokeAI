...
* **Canvas presets pin the short edge**: 512p, 704p (default) or 768p, with the long edge following your aspect ratio and both axes snapped to a multiple of 32.
...
* **LTX-2.5 Components** — the video VAE, audio VAE, vocoder and text connectors, which go in the panel's **Model components** slot.
