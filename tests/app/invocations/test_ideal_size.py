...
IDEAL_SIZE_AT_NODE_DEFAULTS: dict[BaseModelType, tuple[int, int]] = {
    ...
    # Declared 1280x704 (non-square, like H3): 901120 px at 1.7778 -> height sqrt(506880) = 711.95
    # -> 711 -> 704 on the 32 grid; width 1265.7 -> 1265 -> 1248.
    BaseModelType.LTX2: (1248, 704),
