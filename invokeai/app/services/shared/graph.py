...
class _ExecutionMaterializer:
    ...
    def create_execution_node(
        self, node_id: str, iteration_node_map: list[tuple[str, str]], iter_context: tuple[str, ...] = ()
    ) -> list[str]:
...
class GraphExecutionState(BaseModel):
    ...
    def _create_execution_node(
        ...
        return self._materializer().create_execution_node(node_id, iteration_node_map, iter_context=iter_context)
