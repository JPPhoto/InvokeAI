...
/**
 * Widget-chrome footer: point count, how those points clustered, a stale hint
 * while a recompute is pending, embedding-index progress (admins only receive
 * those events), and a manual refresh.
 */
